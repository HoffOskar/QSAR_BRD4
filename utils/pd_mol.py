...
def grid_view(mol_col):
    ...
    '''
    return Draw.MolsToGridImage(mol_col,
...
### Functions
def standardize_mol_col(mol_col, 
                          largest_frag=True, 
                          remove_charge=True, 
                          tautomerize=False, 
                          normalize=True,
    ...
    if cal_2D_coord_deep:
        print(f'cal_2D_coord_default=not required (rdDepictor.Compute2DCoords):')
        ...
        print(f'cal_2D_coord_default={cal_2D_coord_default} (rdDepictor.Compute2DCoords):')
